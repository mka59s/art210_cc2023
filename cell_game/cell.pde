class Cell
{
  float d = 10; // width and height
  int px = 0; //position on the x axis
  int py = 0; //position on the y axis
  ...
  void check()
  {
    ...
    //Any Dead cell with three live neighbours become a live cell.
    //all other live cells die in the next generation. Similarly, all other dead cells will die
  }
}
